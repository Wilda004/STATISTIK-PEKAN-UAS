...
file_path = 'Smoking Drinking Dataset 1000 data 10 var.csv'

# Membaca data dari file CSV
data = pd.read_csv(file_path, delimiter=',')

# Memilih 10 variabel independen yang numerik
independent_variables = [ 'height','weight','sight_left','sight_right','SBP','DBP','BLDS','HDL_chole','LDL_chole','triglyceride']
